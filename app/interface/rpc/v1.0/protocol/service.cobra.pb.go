...
It is generated from these files:
	app/interface/rpc/v1.0/protocol/service.proto
	app/interface/rpc/v1.0/protocol/user.proto

It has these top-level commands:
	BackendClientCommand
	UserServiceClientCommand
*/
...
import (
	...
	google_protobuf_pb "github.com/golang/protobuf/ptypes/empty"
...
var _DefaultBackendClientCommandConfig = _NewBackendClientCommandConfig()

type _BackendClientCommandConfig struct {
...
func _NewBackendClientCommandConfig() *_BackendClientCommandConfig {
	c := &_BackendClientCommandConfig{}
	envconfig.Process("", c)
	return c
}

func (o *_BackendClientCommandConfig) AddFlags(fs *pflag.FlagSet) {
...
func _DialBackend() (*grpc.ClientConn, BackendClient, error) {
	cfg := _DefaultBackendClientCommandConfig
	...
	return conn, NewBackendClient(conn), nil
}

type _BackendRoundTripFunc func(cli BackendClient, in iocodec.Decoder, out iocodec.Encoder) error

func _BackendRoundTrip(sample interface{}, fn _BackendRoundTripFunc) error {
	cfg := _DefaultBackendClientCommandConfig
